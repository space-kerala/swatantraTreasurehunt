  ...
  <head>
    ...
    <link href="//netdna.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css" rel="stylesheet">
     <link href="{{ URL::asset('css/navigationbar.css') }}" rel="stylesheet"> 
      <link href="{{ URL::asset('css/adquestview.css') }}" rel="stylesheet">
...
<div class="container1">
  <form enctype="multipart/form-data" action="{{ route('addquestion') }}" method="POST" id="addquestionform">


 <p style="text-align:center;color:orange;font-size:18px;margin: 0px;"><?php echo $status ?></p>
 

{{csrf_field() }}
<p id="headsignup"><strong>Add Question</strong></p>
<div class="form-signin">

<br>  
<br>      
<br>  
<label for="useridlogin" class="useridlogin" id="controllabel">* User type</label>
<select name="usertype" class="useridlogin" form="addquestionform" id="usertypeselect">
  <option value="s">Student</option>
  <option value="t">Others</option>
  </select> 
<label for="useridlogin" class="useridlogin" id="controllabel1">*Question No</label>
    <input type="number" spellcheck=false class="useridlogin" id="phoneno"  name="questno" placeholder="Enter Question Number " required>


<label for="useridlogin" class="useridlogin" id="controllabel">*Question</label>
    <input type="text" spellcheck=false class="useridlogin" id="name"  name="quest" placeholder="Enter Question " required>
 
 
<label for="useridlogin" class="useridlogin" id="controllabel">Answer</label>
    <input type="text" spellcheck=false class="useridlogin" id="college" name="answer" placeholder="Enter Answer " required>
  

<label id="controllabel3" class="useridlogin">Upload Question image :</label>
<input type="file" class="useridlogin" name="imagefullname" id="imagefullname">

<label for="useridlogin" id="controllabel" class="useridlogin">Image Name</label>
    <input type="text" spellcheck=false class="useridlogin" id="imagename" name="imagename" placeholder="Enter image name to be stored in hunt-questions folder" required>
    
 </div>
 <br>
 <button id="subsignin" type="submit">Add</button>
